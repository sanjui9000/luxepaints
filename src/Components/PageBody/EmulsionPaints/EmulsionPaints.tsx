...
import './EmulsionPaints.scss';

export const EmulsionPaints = () => {
    return <div className="emulsions__page-body">
        <Heading header='Future of' subHeader='painting services.' alternateHeadingColor='#6f0000'/>
                ...
                <FadeIn>
                    ...
                    units are certified environmentally safe.' heading='Our Products' switchBorders/>
                </FadeIn>
        <ProductCard/>
        <ProductCard isReverse={true} />
        <ProductCard/>
    </div>
}
